    ...
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 sm:gap-y-10">
          ...
          <div className='border rounded-md shadow-md px-12 py-16 space-y-2 md:col-span-1'>
            <div className='bg-indigo-600 flex justify-between items-center rounded-md px-4 py-4'>
              <div className='flex space-x-4'>
            ...
            <div className='bg-white flex justify-between items-center rounded-md px-4 py-4 hover:bg-slate-100'>
              <div className='flex space-x-4'>
          ...
          <div className='border rounded-md shadow-md px-12 py-16 space-y-2 md:col-span-2'>
            <div>
              <p>Monthly Plan #1</p>
              <p>Limitless Possibilites</p>
            </div>
            <div>
              <div>
                <p>Services</p>
                <ul>
                  ...
                  <li>Logo Design</li>
                  <li>Image Ads (max 8 per month)</li>
                </ul>
              </div>
              <div>
                <p>Features</p>
