              ...
              monthlyPlans.map(plan => (
                <div className='relative border rounded-2xl shadow-lg px-12 py-16 space-y-8' key={plan.title}>
                  <div className='space-y-2 text-center md:text-left'>
                    <p className='text-indigo-600 text-4xl font-bold'>{plan.title}</p>
                  ...
                  <div className='text-center lg:absolute lg:top-0 lg:right-0 lg:-translate-x-8 lg:translate-y-8'>
                    <button className='bg-indigo-600 text-slate-50 text-lg px-8 py-3 rounded-full shadow-md font-medium select-none hover:shadow-lg hover:bg-indigo-700'>
